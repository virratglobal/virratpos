...
$(document).ready(function() {
    ...
    $('ul.tabs li').click(function () {
        ...
        /****  TAB Js ****/
        // $('.nice-select ul.tabs li').click(function () {
        //     var tab_id = $(this).attr('data-tab');
        //     $(this).closest('.tabs-wrapper').find('.tab-link').removeClass('active');
        //     $(this).addClass('active');
        //     $(this).closest('.tabs-wrapper').find('.tab-content').removeClass('active');
        ...
        $('.nice-select ul.tabs li').click(function () {
            var tab_id = $(this).attr('data-tab');
            $(this).closest('.search-cat-section').find('.tab-link').removeClass('active');
            $(this).addClass('active');
            $('.popular-itm-section').find('.tab-content').removeClass('active');
            $('.popular-itm-section').find('.tab-content#' + tab_id).addClass('active');
            $('.popular-itm-section').find('.slick-slider').slick('refresh');
        });
    ...
    if ($('.social-media-slider').length > 0) {
