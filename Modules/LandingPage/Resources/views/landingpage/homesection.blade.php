...
<div class="landing-container">
    {{ Form::open(['route' => 'homesection.store', 'method' => 'post', 'id' => 'imageUploadForm', 'enctype' => 'multipart/form-data', 'class'=>'needs-validation', 'novalidate' => true]) }}
        ...
        <div>
            ...
            <div class="landing-card">
                ...
                <div>
                    ...
                    <textarea name="home_description" class="form-textarea-white" rows="3" placeholder="{{ __('Enter Subheadline') }}">{{ $settings['home_description'] ?? 'A unified platform designed for scalability, performance, and unparalleled control. Join thousands of enterprises transforming their operations today.' }}</textarea>
            ...
            <div class="landing-card">
                <div class="landing-card-header">
                    ...
                    <button type="button" class="btn-add-feature" data-repeater-create title="{{ __('Add Feature') }}">
                        <span class="material-symbols-outlined text-[20px]">add</span>
                    </button>
                </div>

                <!-- Draggable Repeater List -->
                <div data-repeater-list="home_logo">
                    <div class="repeater-item-box" data-repeater-item>
                        ...
                        <button type="button" class="text-red-500 hover:text-red-700 delete-repeater-item p-1" title="{{ __('Delete') }}">
                ...
                <div>
                    ...
                    <div class="og-image-preview-card">
                        @if(!empty($settings['home_banner']))
                            <img id="image" src="{{ $logo . '/' . $settings['home_banner'] }}" alt="OG Banner">
                        @else
                            <img id="image" src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&auto=format&fit=crop&q=60" alt="OG Banner">
                        @endif
                    </div>
                    <label for="home_banner" class="btn-discard-changes w-full justify-center mt-3 cursor-pointer">
                        <span class="material-symbols-outlined text-[18px]">upload</span>
                        <span>{{ __('Change Banner Image') }}</span>
                        <input type="file" name="home_banner" id="home_banner" class="d-none" onchange="document.getElementById('image').src = window.URL.createObjectURL(this.files[0])">
                    </label>
                </div>
            </div>
