...
class TestimonialsController extends Controller
{
    ...
    {
        $data['testimonials_status']= isset($request->testimonials_status) ? $request->testimonials_status : 'off';
    ...
    public function testimonials_store(Request $request){
        ...
        return redirect()->back()->with(['success'=> __('Testimonials add successfully')]);
    }
    ...
    public function testimonials_update(Request $request, $key){
        ...
        return redirect()->back()->with(['success'=> __('Testimonials update successfully')]);
    }
