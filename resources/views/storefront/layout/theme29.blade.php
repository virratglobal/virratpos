...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme29/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme29/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme29/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('assets/theme29/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme29/css/responsive.css') }}">
    @endif
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme29-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme29/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme29/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme29/js/custom.js') }}" defer="defer"></script>
    @endif
