...
<head>
    ...
    <link rel="icon"
        ...
        type="image/png">
    <link rel="stylesheet" href="{{ asset('assets/theme17/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme17/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme17/css/rtl-responsive.css') }}">
    @else
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme17-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme17/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme17/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme17/js/custom.js') }}" defer="defer"></script>
    @endif
