...
@php
    ...
    if (preg_match('/^theme([1-2][0-9]|30)-v([0-9]+)$/', $themeClass, $matches)) {
        $mapped_num = (($matches[1] - 1) % 10) + 1;
        $themeClass = 'theme' . $mapped_num . '-v' . $matches[2];
    }
...
<head>
    ...
    <link rel="icon"
        ...
        type="image/png">
    <link rel="stylesheet" href="{{ asset('assets/theme27/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme27/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme27/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('assets/theme27/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme27/css/responsive.css') }}">
    @endif
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,700;1,400&family=Montserrat:wght@400;500&display=swap" rel="stylesheet">
    <style>
        :root {
            --theme-color: #991b1b !important;
            --theme-color-hover: #991b1bcc !important;
            --bg-color: #150d0d !important;
            font-family: 'Montserrat', sans-serif !important;
        }
        body, p, span, a, button, input, select, textarea {
            font-family: 'Montserrat', sans-serif !important;
        }
        body { background-color: #150d0d !important; color: #f5f5f5 !important; } .wrapper { background-color: #150d0d !important; } .product-box, .card, .about-promotions { background: #1e1313 !important; border: 1px solid #3b2323 !important; border-radius: 0px !important; } .btn, .cart-btns .btn, .btn-primary { background-color: transparent !important; border: 1px solid #991b1b !important; color: #f5f5f5 !important; border-radius: 0px !important; } .btn:hover, .btn-primary:hover { background-color: #991b1b !important; } h1, h2, h3, h4, h5, h6 { font-family: 'Cormorant Garamond', serif !important; color: #eab308 !important; }
    </style>
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme27-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme27/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme27/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme27/js/custom.js') }}" defer="defer"></script>
    @endif
