...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme15/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
    <link rel="stylesheet" href="{{ asset('assets/theme15/css/main-style-rtl.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/theme15/css/responsive-rtl.css') }}">
    @else
    ...
    <style>
        :root {
            ...
            --theme-color-hover: #db2777cc !important;
            --bg-color: #fffbfb !important;
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme15-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme15/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme15/js/custom-rtl.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme15/js/custom.js') }}" defer="defer"></script>
    @endif
    <script>
        var dataTabelLang = {
            paginate: {
