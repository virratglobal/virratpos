...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme24/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme24/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme24/css/rtl-responsive.css') }}">
    @else
    <link rel="stylesheet" href="{{ asset('assets/theme24/css/main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/theme24/css/responsive.css') }}">
    @endif
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme24-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme24/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme24/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme24/js/custom.js') }}" defer="defer"></script>
    @endif
    <script>
        var dataTabelLang = {
            paginate: {
