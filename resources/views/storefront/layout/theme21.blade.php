...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/theme21/images/favicon.png') }}">
    <link rel="icon"
        href="{{ asset(Storage::url('uploads/logo/') . (!empty($setting->value) ? $setting->value : 'favicon.png' . '?timestamp='. time())) }}"
        type="image/png">
    <link rel="stylesheet" href="{{ asset('assets/theme21/fonts/fontawesome-free/css/all.min.css') }}">

    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme21/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme21/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('assets/theme21/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme21/css/responsive.css') }}">
    @endif
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        :root {
            --theme-color: #0284c7 !important;
            --theme-color-hover: #0284c7cc !important;
            --bg-color: #f0f9ff !important;
            font-family: 'Inter', sans-serif !important;
        }
        body, p, span, a, button, input, select, textarea {
            font-family: 'Inter', sans-serif !important;
        }
        body { background-color: #f0f9ff !important; color: #0f172a !important; } .wrapper { background-color: #f0f9ff !important; } .product-box, .card, .about-promotions { background: #ffffff !important; border-radius: 6px !important; border: 1px solid #bae6fd !important; } .btn, .cart-btns .btn, .btn-primary { background-color: #0284c7 !important; border-color: #0284c7 !important; color: #fff !important; border-radius: 6px !important; }
    </style>
...
<body class="{{ !empty($themeClass) ? $themeClass : 'theme21-v1' }}">
    ...
    @endif
    <!--scripts start here-->
    {{--  <script src="{{ asset('assets/theme21/js/jquery.min.js') }}"></script>  --}}
    <script src="{{ asset('custom/js/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/js/plugins/bootstrap.min.js') }}"></script>
    <script src="{{ asset('custom/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('assets/theme21/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme21/js/rtl-custom.js') }}"></script>
    @else
        <script src="{{ asset('assets/theme21/js/custom.js') }}" defer="defer"></script>
    @endif
    <script>
        var dataTabelLang = {
            paginate: {
