...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme26/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme26/css/main-style-rtl.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme26/css/responsive-rtl.css') }}">
    @else
    <link rel="stylesheet" href="{{ asset('assets/theme26/css/main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/theme26/css/responsive.css') }}">
    @endif
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme26-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme26/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme26/js/custom-rtl.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme26/js/custom.js') }}" defer="defer"></script>
    @endif
   <script>
        var dataTabelLang = {
            paginate: {
