...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme14/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme14/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme14/css/rtl-responsive.css') }}">
    @else
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme14-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme14/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme14/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme14/js/custom.js') }}" defer="defer"></script>
    @endif
    <script>
        var dataTabelLang = {
            paginate: {
