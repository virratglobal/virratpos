...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme19/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme19/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme19/css/rtl-responsive.css') }}">
    @else
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme19-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme19/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme19/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme19/js/custom.js') }}" defer="defer"></script>
    @endif
