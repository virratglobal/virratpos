...
<head>
    ...
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme12/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme12/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('assets/theme12/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme12/css/responsive.css') }}">
    @endif
...
<body class="{{ !empty($themeClass) ? $themeClass : 'theme12-v1' }}">
    @php
    ...
    @endif
    {{--  <script src="{{ asset('assets/theme12/js/jquery.min.js') }}"></script>  --}}
    <script src="{{ asset('custom/js/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/js/plugins/bootstrap.min.js') }}"></script>
    <script src="{{ asset('custom/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('assets/theme12/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme12/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme12/js/custom.js') }}" defer="defer"></script>
    @endif
    <script>
        var dataTabelLang = {
            paginate: {
