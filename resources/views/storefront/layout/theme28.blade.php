...
<head>
    ...
    <link rel="icon"
        ...
        type="image/png">
        <link rel="stylesheet" href="{{ asset('assets/theme28/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
        <link rel="stylesheet" href="{{ asset('assets/theme28/css/main-style-rtl.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme28/css/responsive-rtl.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('assets/theme28/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/theme28/css/responsive.css') }}">
    @endif
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;800&display=swap" rel="stylesheet">
    <style>
        :root {
            --theme-color: #000000 !important;
            --theme-color-hover: #000000cc !important;
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme28-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme28/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme28/js/custom-rtl.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme28/js/custom.js') }}" defer="defer"></script>
    @endif
