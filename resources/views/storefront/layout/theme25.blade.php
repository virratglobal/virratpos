...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme25/fonts/fontawesome-free/css/all.min.css') }}">
    @if (isset($data->value) && $data->value == 'on')
    <link rel="stylesheet" href="{{ asset('assets/theme25/css/main-style-rtl.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/theme25/css/responsive-rtl.css') }}">
    @else
    <link rel="stylesheet" href="{{ asset('assets/theme25/css/main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/theme25/css/responsive.css') }}">
    @endif
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,700;1,400&family=Montserrat:wght@400;500&display=swap" rel="stylesheet">
    <style>
        :root {
            --theme-color: #be185d !important;
            --theme-color-hover: #be185dcc !important;
...
<body class="{{ !empty($themeClass)? $themeClass : 'theme25-v1' }}">
    @php
    ...
    <script src="{{ asset('assets/theme25/js/slick.min.js') }}" defer="defer"></script>
    ...
    @endif
    @if (isset($data->value) && $data->value == 'on')
        <script src="{{ asset('assets/theme25/js/custom-rtl.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('assets/theme25/js/custom.js') }}" defer="defer"></script>
    @endif
    <script>
        var dataTabelLang = {
            paginate: {
