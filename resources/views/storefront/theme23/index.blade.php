                        ...
                        @foreach($getStoreThemeSetting as $storethemesetting)
                            @if($storethemesetting['section_name'] == 'Banner-Image')
                                <div class="main-banner-img">
                                    <img src="{{$imgpath.(!empty($storethemesetting['inner-list'][0]['field_default_text'])?$storethemesetting['inner-list'][0]['field_default_text']:'theme23/header/header_img_3.png')}}" alt="">
                                </div>
                            @endif
                        @endforeach
                    @endif
                                        ...
                                        {{--  <div class="testimonial-slider">  --}}
                                            <div class="testimonial-card">
                                                ...
                                                <div class="testimonial-img">
                                                    <img src="{{ $imgpath. (!empty($storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text']) ? $storethemesetting['homepage-testimonial-card-image'][$i]['field_prev_text'] : 'theme23/header/header_img_3.png') }}" alt="">
                                                </div>
                                            </div>
                                        {{--  </div>  --}}
                                    @endif
                            ...
                            @else
                                @for ($i = 0; $i < $storethemesetting['loop_number']; $i++)
                                        ...
                                        <div class="testimonial-card">
                                            ...
                                            <div class="testimonial-img">
                                                <img src="{{$imgpath.(!empty($storethemesetting['inner-list'][1]['field_default_text']) ? $storethemesetting['inner-list'][1]['field_default_text'] : 'theme23/header/header_img_3.png')}}" alt="">
                                            </div>
                                        </div>
