...
@endsection
@push('script-page')
{{--<script src="{{asset('assets/theme23/js/all.min.js')}}"></script>--}}
{{-- <script src="{{asset('assets/theme23/js/purpose.core.js')}}"></script> --}}
<script src="{{asset('assets/theme23/js/swiper.min.js')}}"></script>
<script src="{{asset('assets/theme23/js/purpose.js')}}"></script>
