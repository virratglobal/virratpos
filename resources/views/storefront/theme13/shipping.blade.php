...
@endsection
@push('script-page')
{{--<script src="{{asset('assets/theme13/js/all.min.js')}}"></script>--}}
{{-- <script src="{{asset('assets/theme13/js/purpose.core.js')}}"></script> --}}
<script src="{{asset('assets/theme13/js/swiper.min.js')}}"></script>
<script src="{{asset('assets/theme13/js/purpose.js')}}"></script>
