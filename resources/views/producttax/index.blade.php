    ...
    <x-ui.page-header title="{{ __('Product Tax') }}">
        ...
        <x-slot name="actions">
            @can('Create Product Tax')
                <a href="#" data-url="{{ route('product_tax.create') }}" data-title="{{ __('Create New Product Tax') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create') }}">
