                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="{{__('Name')}}" value="{{ Auth::user()->name }}" disabled>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-prepend"><span
                                                ...
                                                <input class="form-control" type="number" placeholder="{{__('Amount')}}" value="{{ $price }}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
