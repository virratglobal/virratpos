...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">
        <link rel="icon" href="{{asset('custom/AuthorizeNet/images/favicon.png')}}">
        <link rel="stylesheet" href="{{asset('custom/AuthorizeNet/css/style.css')}}">
        <link rel="stylesheet" href="{{asset('custom/AuthorizeNet/css/main-style.css')}}">
        <link rel="stylesheet" href="{{asset('custom/AuthorizeNet/css/responsive.css')}}">
        <link rel="stylesheet" href="{{asset('custom/AuthorizeNet/css/daterangepicker.css')}}">
    <style>
        .expiration input {
            border: 0;
        }
            ...
            <div class="card">
                <div class="card-body w-100">
                    <div class="payment-logo text-center pb-3">
                        <img src="{{asset('custom/AuthorizeNet/images/payment-logo.jpg')}}" alt="payment-logo" loading="lazy">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="{{__('Name')}}" value="{{ $authuser->name }}" disabled>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-prepend"><span
                                                ...
                                                <input class="form-control" type="number" placeholder="{{__('Amount')}}" value="{{ $get_amount }}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" pattern="\d{16}"  type="text" placeholder="{{__('Enter Card Number')}}" name="cardNumber" required>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" placeholder="{{__('Enter CVV')}}" name="cvv" maxlength="3" size="3" required>
                                </div>
                            </div>
                            <div class="col-sm-4 form-group" >
                                ...
                                <div class=" expiration form-control">
                                    <input type="text" class="" name="month" placeholder="{{__('MM')}}" maxlength="2" size="2" />
                                    <span>/</span>
                                    <input type="text" class="" name="year" placeholder="{{__('YYYY')}}" maxlength="4" size="4" />
                                </div>
                            </div>
